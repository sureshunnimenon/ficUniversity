   ...
   while(have_posts()){
    ...
    <div class="page-banner__content container container--narrow">
      ...
      <div class="page-banner__intro">
        <p> Dont forget to Replace with code later</p>
      </div>
    </div>  
  </div>
    ...
    $theParent= wp_get_post_parent_id(get_the_ID());
      if($theParent){ ?>
        <div class="metabox metabox--position-up metabox--with-home-link">
          ...
          </i> Back to <?php echo get_the_title($theParent);     ?></a> <span class="metabox__main"><?php echo the_title()   ?></span></p>
        </div>
        <?php
      }
    ?>
        ...
        <h2 class="page-links__title"><a href="<?php get_permalink($theParent); ?>"><?php echo get_the_title($theParent);  ?></a></h2>
            <ul class="min-list">
              <?php 
                  ...
                  wp_list_pages(['title_li' => NULL, 'child_of' => $findChildrenOf]);        
              ?>
            </ul>
          </div>
